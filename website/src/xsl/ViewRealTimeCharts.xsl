        ...
        <div id="sf" style="height:135px;">
            <div id="realtimegraphs">
                <div id="chatdiv">
                    ...
                    <APPLET ARCHIVE="commons-logging-1.1.1.jar,log4j-1.2.17.jar,jfreechart-1.0.14.jar,commons-collections-3.2.1.jar,jcommon-1.0.17.jar,logParser-applets-1.1.jar,LiveLogParser-1.1.jar,LiveLogParserBeans-1.1.jar,jgroups.jar,concurrent-1.3.4.jar,bos-common-logging.jar,jaws.jar,commons-codec-1.4.jar,joda-time-2.1.jar"
